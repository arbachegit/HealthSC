...
export const SCENES: CanopyScene[] = [
  { bg: '#c8e0d0', hero: 'Da queixa ao protocolo',    mockup: 'prompt', promptText: 'Estou com febre há 3 dias e dor nas costas', hold: HOLD },
  { bg: '#eef0e0', hero: 'Triagem antes da fila',     mockup: 'prompt', promptText: 'Mais perto do meu CEP, hoje', hold: HOLD },
